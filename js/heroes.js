var heroes = [{
  ...
  "First Appearance": "(Captain America) Captain America Comics #1 (1941); (Nomad) Captain America #180 (1974); (Captain) Captain America #337 (1988)",
  ...
  "Abilities": "Dr. Bruce Banner is a genius in nuclear physics, possessing a mind so brilliant that it cannot be measured on any known intelligence test. When Banner is the Hulk, Banner's consciousness is buried within the Hulk's, and can influence the Hulk's behavior only to a very limited extent. less",
  "name": "HULK",
  ...
  "Group Affiliations": "The Avengers, Initiative, Hellfire Club (outer circle), S.H.I.E.L.D., Illuminati, Thunderbolts, Force Works, Queen's Vengeance, Alcoholics Anonymous",
  "Powers": "None;"
}, {
  ...
  "Group Affiliations": "Guardians of the Galaxy, formerly Howling Commandos",
  "Powers": "Groot was extremely powerful and resilient, he has the power or regeneration allowing him to re-grow limbs and even his entire form. He also has powers of the mind, although they only appear to work on plant life, allowing him to communicate with other trees and command them to attack those that oppose him. He is highly vulnerable to attacks of fire. less"
}, {
  ...
  "Height": "5'7\"",
  "Group Affiliations": "Formerly Avengers, Avengers West Coast, Brides of Set, Brotherhood of Mutants, Brotherhood of Evil Mutants, Force Works, Lady Liberators, Secret Defenders; former student of Harkness, Agatha, Agatha Harkness",
  "Powers": "The Scarlet Witch can tap into mystic energy for reality-altering effects; this power was formerly limited to the creation of \"hex-spheres\" of reality-disrupting quasi-psionic force to cause molecular disturbances in a target's probability field, resulting in spontaneous combustion, deflection of objects in flight, and so on. She later became able to alter reality on a far greater scale, creating entire armies of enemies from nowhere. Although the Scarlet Witch has been trained in basic sorcery techniques, she lacks the specialized mystic training required to fully control her power. less"
}, {
  ...
  "Abilities": "In addition, Star-Lord is highly athletic, a skilled marksman and swordsman, and proficient at hand-to-hand combat. After overcoming his lifetime of hatred, Star-Lord took a vow to never take another life unless absolutely necessary. His greatest asset is his partner and would-be lover, Ship. less",
  "name": "STAR-LORD",
  "Weight": "175 lbs.",
  "Real Name": "Peter Jason Quill",
  "Height": "6'2\"",
  "Group Affiliations": "Guardians of the Galaxy; formerly the United Front, Imperial Guard, Shi'ar Imperial Guard, partner of Ship (Aurora), Ship",
  ...
  "Group Affiliations": "Gods of Asgard, Avengers; formerly Queen\u2019s Vengeance, Godpack, Thor Corps",
